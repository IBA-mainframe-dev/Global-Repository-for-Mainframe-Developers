...
**`CUSTTGT` - This JCL job is used to custome SMPe target zone environment**

[**Link to clone/download from the repository**](https://github.com/IBA-mainframe-dev/Global-Repository-for-Mainframe-Developers/blob/master/zOS%20System%20operating/SMPe/JCL%20job%20for%20customizing%20SMPe%20target%20zone%20environment/CUSTTGT)

```
//CUSTTGT  JOB <JOB PARAMETERS>
//******************************************************//
//*  THIS JOB IS USED TO CUSTOMIZE                     *//
//*  SMP/E TARGET ZONE ENVIRONMENT                     *//
//*                                                    *//
//*  INSTRUCTIONS:                                     *//
...
//SMPCNTL DD *
  ...
  .
  ADD DDDEF(SMPPTS) DA(USERHLQ.SMPPTS) SHR
  .
  ...
  ADD DDDEF(SYSPUNCH) BLK(6160) SPACE(300,400) DIR(91)
   UNIT(SYSDA)
  .
  ADD DDDEF(PARMLIB) SHR DA(SYS1.PARMLIB)
  .
  ADD DDDEF(USRLIB1) SHR DA(USERHLQ.USRLIB1)
  .
  ADD DDDEF(AUSRLIB1) SHR DA(USERHLQ.AUSRLIB1)
  .
  ADD DDDEF(USRLIB2) SHR DA(USERHLQ.USRLIB2)
  .
  ADD DDDEF(AUSRLIB2) SHR DA(USERHLQ.AUSRLIB2)
  .
  ADD DDDEF(USRLIB3) SHR DA(USERHLQ.USRLIB3)
  .
