#  Terminate DB2 Utility. Start DB2 Tablespace with RW access. Repair DB2 Tablespace from COPY status
...
//             UID=''
//SYSIN     DD  *
  REPAIR SET TABLESPACE DATABASE_NAME.TABLESPACE_NAME NOCOPYPEND  
```
